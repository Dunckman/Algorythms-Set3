#ifndef SET_2_SORTINGALGORITHMS_H
#define SET_2_SORTINGALGORITHMS_H
...
inline void hybridMergeSort(std::vector<int>& arr, int left, int right, int threshold) {
    if (left >= right) {
        return;
    }
...
#endif //SET_2_SORTINGALGORITHMS_H